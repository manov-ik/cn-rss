...
export const ArticleListVirtual = React.memo(
  React.forwardRef<ArticleListVirtualRefType, ArticleListVirtualProps>((props: ArticleListVirtualProps, ref) => {
    ...
    const handleScroll = useCallback(() => {
      ...
      const { scrollTop, scrollHeight, clientHeight } = internalParentRef.current;
    ...
    return (
      <div ref={internalParentRef} className="w-full flex-1 overflow-y-auto scrollbar-gutter ">
        {isEmpty ? (
          <div className="flex flex-col justify-center items-center text-muted-foreground min-h-full py-20">
