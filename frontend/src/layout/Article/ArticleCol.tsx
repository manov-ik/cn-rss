...
export const ArticleCol = React.memo(
  React.forwardRef<ArticleColRefObject, any>(
        ...
        if (store.feed && store.feed.item_type === "channel") {
          ...
          return (
            <HoverCard.Root>
              ...
              <HoverCard.Content
                size="1"
                className="p-3 w-[320px] flex gap-3 flex-row"
              >
                <Avatar
                  size="4"
                  src={ico}
                ...
                <div className="flex-1 flex flex-col gap-1">
                  ...
                  <div className="text-xs text-[var(--gray-11)] break-all">
                    {store.feed.description}
                  </div>
                  <div className="flex gap-4 mt-2">
                    <IconButton size="2" variant="ghost" color="gray">
                      <Link
                        size={14}
                        onClick={() => window.open(store.feed?.link, "_blank")}
                      />
                    ...
                    <IconButton size="2" variant="ghost" color="gray">
                      <Rss
                        size={14}
                        onClick={() =>
                          window.open(store.feed?.feed_url, "_blank")
                        }
                      />
